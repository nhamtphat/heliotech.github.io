...
## Vấn đề
Gần đây mình được khách hàng yêu cầu một tính năng tưởng chừng rất cũ nhưng đó giờ mình chưa làm bao giờ, đó là đăng xuất ra khỏi tất cả thiết bị khác sau khi đăng nhập. Có thể hiểu là không thể sử dụng đồng thời trên nhiều thiết bị.
