...
Đối với hướng dẫn Hello World trên Laravel bạn sẽ tìm ra rất nhiều bài viết trên mạng rồi, vì vậy mình muốn chúng ta sẽ đi sâu hơn một chút, có chút gì đó thử thách sẽ làm bạn lý thú hơn.
...
Cụ thể hơn, ví dụ trang web của bạn là yourname.co, với dòng X thì đường link có nghĩa là khi người dùng truy cập vào đường link yourname.com/say-hello với phương thức POST thì sẽ chạy action `sayHello()` trong controller `YournameController`
